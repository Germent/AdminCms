                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" required name="category" autocomplete="off" value="{{ (isset($categories)) ? $categories->category : '' }}">
                        </div>
                        <div class="form-group">
                            <label>Description</label>
                            <textarea name="description" class="form-control">{{ (isset($categories)) ? $categories->description : '' }}</textarea>
                        </div>
